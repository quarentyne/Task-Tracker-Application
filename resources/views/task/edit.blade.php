    ...
    <x-content-wrapper>
        ...
        <form method="post" action="{{ route('task.update', $task) }}">
            ...
            <div class="mt-6">
                ...
                <x-text-input value="{{ $task->title }}" id="title" name="title" class="mt-1 max-w-[50vw] w-full" />
            ...
            <div class="mt-6">
                ...
                <x-select id="category_id" name="category_id" class="mt-1 max-w-[50vw] w-full" selected="{{ $task->category_id }}" :options="$categories" />
